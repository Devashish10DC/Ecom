...
import { login, notify } from "../ReduxToolkit/Slices/AuthSlice";
...
const Login = () => {
  ...
  const userLogin = async (e) => {
    ...
    try {
      const url = `https://identitytoolkit.googleapis.com/v1/accounts:signInWithPassword?key=AIzaSyDDXHFOabjjgsn7RJ4fG5En6zBS84GjDrk`;
      dispatch(
        notify({
          isLoading: true,
          status: "Sending",
